    ...
    <div class="col-md-3">
      ...
      <div class="list-group">
        ...
        <div class="col-md-9 my-5">
          ...
          <p>Soal: 60511 + 60511 = .... <span class="question-mark-icon" data-bs-toggle="popover" data-bs-content="Jika kita menjumlahkan angka 60511 dengan angka 60511, hasilnya adalah 121022."><i class="fas fa-question-circle"></i></span></p>
      ...
      <script>
        function checkAnswer() {
          ...
          if (answer == 121022) {
            alert("Kamu Benar!! Latihan Soal Pertambahan Sudah Selesai dan Anda akan otomatis dipindahkan ke halaman latihan");
            window.location.href = "latihan.php"; // Pengalihan halaman jika jawaban benar
          } else {
