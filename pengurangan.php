    ...
    <div class="col-md-3">
      ...
      <div class="list-group">
        ...
        <div class="col-md-9 my-5">
          ...
          <p>Soal: 45 - 32 = .... <span class="question-mark-icon" data-bs-toggle="popover" data-bs-content="Dalam operasi pengurangan hasilnya adalah 13."><i class="fas fa-question-circle"></i></span></p>
      ...
      <script>
        function checkAnswer() {
          ...
          if (answer == 13) {
            ...
            window.location.href = "pengurangan2.php"; // Pengalihan halaman jika jawaban benar
          } else {
