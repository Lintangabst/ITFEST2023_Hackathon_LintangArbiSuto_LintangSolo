    ...
    <div class="col-md-3">
      ...
      <div class="list-group">
        ...
        <div class="col-md-9 my-5">
          ...
          <p>Soal: 356 - 157 = .... <span class="question-mark-icon" data-bs-toggle="popover" data-bs-content="Dalam operasi pengurangan hasilnya adalah 199"><i class="fas fa-question-circle"></i></span></p>
      ...
      <script>
        function checkAnswer() {
          ...
          if (answer == 199) {
            ...
            window.location.href = "pengurangan3.php"; // Pengalihan halaman jika jawaban benar
          } else {
