    ...
    <div class="col-md-3">
      ...
      <div class="list-group">
        ...
        <div class="col-md-9 my-5">
          ...
          <p>Soal: 4 x 7 = .... <span class="question-mark-icon" data-bs-toggle="popover" data-bs-content="Dalam operasi perkalian hasilnya 28."><i class="fas fa-question-circle"></i></span></p>
      ...
      <script>
        function checkAnswer() {
          ...
          if (answer == 28) {
            ...
            window.location.href = "perkalian2.php"; // Pengalihan halaman jika jawaban benar
          } else {
