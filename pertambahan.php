    ...
    <div class="col-md-3">
      ...
      <div class="list-group">
        ...
        <div class="col-md-9 my-5">
          ...
          <p>Soal: 25 + 25 = .... <span class="question-mark-icon" data-bs-toggle="popover" data-bs-content="Dalam operasi penjumlahan, ketika angka 25 ditambah dengan angka 25, hasilnya adalah 50."><i class="fas fa-question-circle"></i></span></p>
      ...
      <script>
        function checkAnswer() {
          ...
          if (answer == 50) {
            ...
            window.location.href = "pertambahan2.php"; // Pengalihan halaman jika jawaban benar
          } else {
