    ...
    <div class="col-md-3">
      ...
      <div class="list-group">
        ...
        <div class="col-md-9 my-5">
          ...
          <p>Soal: 24 ÷ 4  = .... <span class="question-mark-icon" data-bs-toggle="popover" data-bs-content="Dalam operasi pembagian hasilnya adalah 6."><i class="fas fa-question-circle"></i></span></p>
      ...
      <script>
        function checkAnswer() {
          ...
          if (answer == 6) {
            ...
            window.location.href = "pembagian3.php"; // Pengalihan halaman jika jawaban benar
          } else {
