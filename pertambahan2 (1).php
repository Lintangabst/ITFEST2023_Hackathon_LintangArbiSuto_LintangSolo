    ...
    <div class="col-md-3">
      ...
      <div class="list-group">
        ...
        <div class="col-md-9 my-5">
          <!-- Content -->
          <h2 style="color: #FF7F50; font-style: oblique; font-family: 'Potta One', cursive;">Latihan Penjumlahan</h2>
          <p>Soal: 43 + 109 = .... <span class="question-mark-icon" data-bs-toggle="popover" data-bs-content="Dalam soal matematika 43 + 109, kita harus menjumlahkan angka 43 dengan angka 109. Setelah melakukan penjumlahan, hasilnya adalah 152. Jadi, 43 + 109 = 152."><i class="fas fa-question-circle"></i></span></p>
      ...
      <script>
        function checkAnswer() {
          ...
          if (answer == 152) {
            alert("Kamu Benar!!, Silahkan lanjutkan ke soal berikutnya");
            window.location.href = "pertambahan3.php"; // Pengalihan halaman jika jawaban benar
          } else {
